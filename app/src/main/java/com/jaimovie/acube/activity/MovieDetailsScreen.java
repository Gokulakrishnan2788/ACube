...
public class MovieDetailsScreen extends AppCompatActivity implements UniversalVideoView.VideoViewCallback {

    private static final String TAG = MovieDetailsScreen.class.getSimpleName();
...
//                                payNowBtn.setTypeface(tf);
                        ...
                        case "saveorder":
                            ...
                            if (success == 200) {
                                ...
                                Intent intent = new Intent(mActivity, com.paypal.android.sdk.payments.PaymentActivity.class);
