...
//        Uri mp4VideoUri = Uri.parse("https://gcs-vimeo.akamaized.net/exp=1575561534~acl=%2A%2F1499843879.mp4%2A~hmac=2ba4140c63a1d9e38b6d3879e0eb06f9d541d15717ae824971a00c59fc9353bc/vimeo-prod-skyfire-std-us/01/2846/14/364231783/1499843879.mp4"); //ABC NEWS
        Uri mp4VideoUri = Uri.parse("https://www.youtube.com/watch?v=myBfmZqIT74"); //ABC NEWS
...
////        Uri mp4VideoUri = Uri.parse(Environment.getExternalStorageDirectory().getAbsolutePath()+urimp4);
        ...
        DataSource.Factory dataSourceFactory = new DefaultDataSourceFactory(this, Util.getUserAgent(this, "ACube"), bandwidthMeter);
