...
public class VimeoMovieDetailsScreen extends AppCompatActivity {

    private static final String TAG = VimeoMovieDetailsScreen.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        videoUrl = arguments.getStringExtra("videoUrl");
                        ...
                        case "movieDetails":
                            ...
                            if (success == 200) {
                                ...
                                if (videoUrl != null && !videoUrl.equalsIgnoreCase("") && !videoUrl.equalsIgnoreCase("0")) {
                                    Log.e(TAG, "--Vomeo Loading");
                                    vimeoPlayer.initialize(true, Integer.parseInt(videoUrl));
                                    vimeoPlayer.setFullscreenVisibility(true);
                                    vimeoPlayer.setMenuVisibility(false);
                                    ...
                                    vimeoPlayer.setFullscreenClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            float startAt = vimeoPlayer.getCurrentTimeSeconds();
                                            Log.e(TAG, "--" + startAt);
                                            startActivityForResult(VimeoPlayerActivity.createIntent(mActivity, requestOrientation, vimeoPlayer), REQUEST_CODE);
                                        }
                                    });
                                }
