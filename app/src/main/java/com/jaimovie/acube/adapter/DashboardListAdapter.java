...
public class DashboardListAdapter extends RecyclerView.Adapter<DashboardListAdapter.ImageViewHolder> {

    private Activity mActivity;
    private Dialog dialog;
    private List<MovieList> getCategoryList;

    public DashboardListAdapter(List<MovieList> getCategoryList, Activity animalItemClickListener) {
