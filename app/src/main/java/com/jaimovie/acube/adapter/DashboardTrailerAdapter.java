...
public class DashboardTrailerAdapter extends RecyclerView.Adapter<DashboardTrailerAdapter.ImageViewHolder> {

    private Activity mActivity;
    private Dialog dialog;
    private List<TrailersList> getCategoryList;

    public DashboardTrailerAdapter(List<TrailersList> getCategoryList, Activity animalItemClickListener) {
