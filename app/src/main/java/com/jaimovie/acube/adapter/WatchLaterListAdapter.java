...
public class WatchLaterListAdapter extends RecyclerView.Adapter<WatchLaterListAdapter.ImageViewHolder> {

    private Activity mActivity;
    private Dialog dialog;
    private WatchLaterFragment mFragment;
    private List<WatchLaterList> getCategoryList;

    public WatchLaterListAdapter(List<WatchLaterList> getCategoryList, Activity animalItemClickListener, WatchLaterFragment fragment) {
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ImageViewHolder(LayoutInflater.from(parent.getContext())
                .inflate(R.layout.watch_later_item, parent, false));
    ...
    public void onBindViewHolder(final ImageViewHolder holder, final int position) {
        ...
        holder.deleteIv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mFragment.removeMovie(getCategoryList.get(position).getMovieid());
            }
        });
    }
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder {
        ...
        private ImageView image, deleteIv;
