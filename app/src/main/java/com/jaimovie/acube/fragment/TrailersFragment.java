...
import com.jaimovie.acube.adapter.TrailerInfinityAdapter;
...
public class TrailersFragment extends Fragment {
    ...
    private List<TrailersList> trailerArrList;
    private TrailerInfinityAdapter categoryAdapter;
            ...
            public void notifyJsonSuccess(String requestType, String response, String type) {
                ...
                try {
                    ...
                    if (success == 200) {
                        ...
                        if (pageNo == 1) {
                            categoryAdapter = new TrailerInfinityAdapter(mActivity, trailerArrList);
                            ...
                            categoryAdapter.moreDataLoaded(currSize, trailerArrList.size() - currSize);
                        }

                        if (packageResp.length() == 10) {
                            pageNo = pageNo + 1;
                            categoryAdapter.setShouldLoadMore(true);
                        } else {
    ...
    private InfiniteAdapter.OnLoadMoreListener mLoadMoreListener = new InfiniteAdapter.OnLoadMoreListener() {
        ...
        public void onLoadMore() {
            ...
            map.put("categoryid", "");
            map.put("languageid", "");
            map.put("tag", "trailerlist");
            mVolleyService.postVolleyData("POST", BASE, map, "trailerList");
        }
    };
